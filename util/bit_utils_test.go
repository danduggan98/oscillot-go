...
func TestNthBit(t *testing.T) {
	...
	firstBit := NthBit(0, data)
	secondBit := NthBit(7, data)
	thirdBit := NthBit(8, data)
	fourthBit := NthBit(15, data)
...
func TestBitSlice(t *testing.T) {
	...
	zerosSlice := BitSlice(13, 15, data)
